...
// The clickable catalogue tile. UCard has no `to` prop in Nuxt UI v4, so the
// whole card is wrapped in a ULink (rendered raw to avoid link theming). This is
// also used as the hover-popover trigger in ShowCard, so it keeps a single root.
