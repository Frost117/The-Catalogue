...
// search input into a committed term, and keeps both in sync with the URL
// so results are shareable + SSR-able.
export function useCatalogueFilters(genres: () => string[] | null | undefined) {
  ...
  return { searchInput, search, genre, genreSelection, genreItems, hasFilters, clearFilters }
}
